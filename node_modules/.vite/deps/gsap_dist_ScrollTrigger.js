...
var require_ScrollTrigger = __commonJS({
  "node_modules/gsap/dist/ScrollTrigger.js"(exports, module) {
    (function(global, factory) {
      ...
      }, _callback = function _callback2(self2, func, extraParam) {
        if (self2.enabled) {
                ...
                if (scroll <= end && scroll >= start && endScroll !== scroll) {
                  ...
                  tweenTo(endScroll, {
                    ...
                    onInterrupt: function onInterrupt() {
                      return snapDelayedCall.restart(true) && _onInterrupt && _callback(self2, _onInterrupt);
                    },
                    onComplete: function onComplete() {
                      self2.update();
                      lastSnap = scrollFunc();
                      ...
                      _onComplete && _callback(self2, _onComplete);
                    }
                  }, scroll, change1 * change, endScroll - scroll - change1 * change);
                  onStart && _callback(self2, onStart, tweenTo.tween);
                }
          ...
          if (gsap$1) {
            ...
            if (_body$1) {
              ...
              var onLoad = function onLoad2() {
                ...
                _doc$1.removeEventListener("DOMContentLoaded", onLoad2);
              };
